...
T_aw = 400 # max gas side wall temp, [K], from SCA
...
# Aluminum EN - 1706 parameters # --> recheck for 17-4 H900

k_tc = 130 # thermal conductivity, [W/m*K] for 21-500 deg C
v = 0.33 # poisson ratio
E = 73e9 # young's modulus, [Pa], could be up to 207
S_ult = 450e6 # ultimate strength, [Pa]
S_y = 271e6 # yield stress, [Pa]
# D = # stiffness matrix
a = 1.9e-6 # thermal expansion coefficient, [m/m*K], for +21C to +427C
r_tc = 2.67*1000 # mass density, [kg/m^3] 
Cp_tc = 910 # specific heat, [J/kg*K]
T_melt = 515+273 # melting temperature, [K]
...
Pl = 300*6894.76 # coolant pressure in channel, [Pa] aka 300 psi
